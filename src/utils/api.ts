...
export const fetchPatientsAsAdmin = (page: number, pageSize: number, name?: string | undefined) => {
...
export const fetchDoctorsAsAdmin = (page: number, pageSize: number, name?: string | undefined) => {
...
export const createPatient = (name: string, email: string, birthDate?: string) => {
...
export const deassignPatientToDoctor = (doctorId: string, patientId: string) => {
  const data = {
    doctor_id: doctorId,
    patient_id: patientId,
  };
